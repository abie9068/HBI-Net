...
│   ├── hbi_net.py                 # HBI-Net change detector
...
│   └── abcd_directional_bloom_dataset.py # public dataset entry point
├── tools/
...
The currently downloadable `ABCD-ms10` archive is the 100-patch preview subset of the full ABCD dataset. It is divided into 60 training, 20 validation, and 20 test patches.
